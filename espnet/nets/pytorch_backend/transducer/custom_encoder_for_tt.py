...
from espnet.nets.pytorch_backend.transducer.blocks_for_tt import build_blocks
...
class CustomEncoder(torch.nn.Module):
    ...
    def forward(self, xs, masks):
        ...
        # print(masks.size())
        # print(masks)
        # print(streaming_mask.size())
        # print(streaming_mask)
        # masks = streaming_mask & masks if streaming_mask is not None and masks is not None else masks
        # print(masks.size())
        # print(masks)
        #######################################################################
